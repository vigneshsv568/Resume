                  ...
                  <Row className="row-grid justify-content-center">
                    <Col lg="3">
                      <div className="info">
                        ...
                        <h4 className="info-title">Enthu Technologies  Solution India Pvt.Ltd</h4>
                        <hr className="line-primary" />
                        <p>
                        Internet of Things Intern – 1month(2019)
                        </p>
                      </div>
                    </Col>
                    <Col lg="3" >
                      <div className="info">
                        ...
                        <h4 className="info-title">Leora Solutions LLP</h4>
                        <hr className="line-warning" />
                        <p>
                        React Native Developer (Android & IOS) –  (2020 - Present) 
                        </p>
                      </div>
                    </Col>
                    {/* <Col lg="3">
